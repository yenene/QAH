...
AHAH = {
    ...
    diag_log "QAH 0.1.9: Starting loops!";
    [] spawn {
        ...
        diag_log "QAH 0.1.9: Detection of hack variables started!";
        while {
            true
        }
        do {
            {
                if !(isNil _x) exitWith {
                    diag_log "QAH 0.1.9: Found a hack variable!";
    ...
    [] spawn {
        ...
        diag_log "QAH 0.1.9: Hack menu check started!";
        while {
            true
        }
        do {
            ...
            if (!(isNull findDisplay 3030) || !(isNull findDisplay 155)) then {
                    ...
                    diag_log "QAH 0.1.9: Found a hack menu!";
    ...
    [] spawn {
        ...
        diag_log "QAH 0.1.9: Godmode check started!";
        while {
            true
        }
        do {
            if (unitRecoilCoefficient player != _recoilSettings) exitWith {
                    diag_log "QAH 0.1.9: Detected recoil hack!";
...
diag_log "QAH 0.1.9: Adding public variable handler";
"hackFlag"
...
diag_log "QAH 0.1.9: Anti-hack should be ready now!";